...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('https://cbcs-project.onrender.com/api/admin/login', {
        method: 'POST',
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await fetch('https://cbcs-project.onrender.com/api/admin/forgot', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        ...
        >
          ...
          {!isForgotPassword ? (
            <form onSubmit={handleLogin}>
              ...
              <p>
                Sample Admin : admin1 Password : 123
              </p>
